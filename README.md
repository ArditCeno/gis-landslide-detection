...
Hex-Pulse Alert System: Custom CSS-animated hexagonal markers that pulse to highlight critical danger points.

IFFI Zone Integration: Visual overlays of official landslide hazard zones (Yellow and Red zones).

Detailed Path Analytics: Popups providing specific data on soil moisture, rainfall, and historical risk scores.
...
JavaScript: Core logic for map rendering, data processing, and dynamic styling.
